...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, globalPrefix, port, expressApp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    common_1.Logger.log(nodeEnv);
                ...
                case 1:
                    ...
                    app.enableCors();
                    if (!(nodeEnv === 'local')) return [3 /*break*/, 3];
                ...
                case 3:
                    ...
                    return [2 /*return*/, serverless_express_1.configure({ app: expressApp })];
